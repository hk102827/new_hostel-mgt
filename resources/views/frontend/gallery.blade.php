        ...
        <section class="gallery_area section_gap">
            <div class="container">
                ...
                <div class="row imageGallery1" id="gallery">
                    ...
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="{{ asset('assets/image/gallery/01-1.jpg') }}" alt="">
                            <div class="hover">
                            	<a class="light" href="{{ asset('assets/image/gallery/01-1.jpg') }}"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="{{ asset('assets/image/gallery/02-1.jpg') }}" alt="">
                            <div class="hover">
                    ...
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="{{ asset('assets/image/gallery/03-1.jpg') }}" alt="">
                            <div class="hover">
                            	<a class="light" href="{{ asset('assets/image/gallery/03-1.jpg') }}"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
