...
<div class="max-w-6xl mx-auto">
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <select name="gender" class="h-12 px-3 block w-full rounded-lg border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 text-base" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="nationality" value="{{ old('nationality', 'Pakistani') }}" 
                               class="h-12 px-3 block w-full rounded-lg border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 text-base" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="sect" value="{{ old('sect') }}" 
                               class="h-12 px-3 block w-full rounded-lg border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 text-base">
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                    <div>
                        ...
                        <textarea name="postal_address" rows="3" 
                                  class="px-3 py-2 block w-full rounded-lg border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 text-base" required>{{ old('postal_address') }}</textarea>
                    </div>
                    
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Current Address *</label>
                        <textarea name="address" rows="3" 
                                  class="px-3 py-2 block w-full rounded-lg border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 text-base" required>{{ old('address') }}</textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div>
                        ...
                        <select name="station" class="h-12 px-3 block w-full rounded-lg border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 text-base">
                            ...
                            <option value="Islamabad" {{ old('station') == 'Islamabad' ? 'selected' : '' }}>Islamabad</option>
                            <option value="Lahore" {{ old('station') == 'Lahore' ? 'selected' : '' }}>Lahore</option>
                            <option value="Karachi" {{ old('station') == 'Karachi' ? 'selected' : '' }}>Karachi</option>
                        </select>
                    </div>
                    ...
                    <div class="qualification-row grid grid-cols-1 md:grid-cols-7 gap-4 mb-4 p-4 border rounded-lg">
                        <div>
                            ...
                            <select name="qualifications[0][degree_type]" class="h-10 px-2 block w-full rounded border-gray-300 text-sm">
                                ...
                                <option value="SSC" {{ old('qualifications.0.degree_type') == 'SSC' ? 'selected' : '' }}>SSC</option>
                                <option value="HSSC" {{ old('qualifications.0.degree_type') == 'HSSC' ? 'selected' : '' }}>HSSC</option>
                                <option value="Bachelor" {{ old('qualifications.0.degree_type') == 'Bachelor' ? 'selected' : '' }}>Bachelor</option>
                                <option value="Masters" {{ old('qualifications.0.degree_type') == 'Masters' ? 'selected' : '' }}>Masters</option>
                                <option value="MS/M.Phil" {{ old('qualifications.0.degree_type') == 'MS/M.Phil' ? 'selected' : '' }}>MS/M.Phil</option>
                                <option value="Ph.D" {{ old('qualifications.0.degree_type') == 'Ph.D' ? 'selected' : '' }}>Ph.D</option>
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Duration (Years)</label>
                            <input type="number" step="0.1" name="qualifications[0][duration_years]" value="{{ old('qualifications.0.duration_years') }}" class="h-10 px-2 block w-full rounded border-gray-300 text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Specialization</label>
                            <input type="text" name="qualifications[0][specialization]" value="{{ old('qualifications.0.specialization') }}" class="h-10 px-2 block w-full rounded border-gray-300 text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Passing Year</label>
                            <input type="number" min="1950" max="2030" name="qualifications[0][passing_year]" value="{{ old('qualifications.0.passing_year') }}" class="h-10 px-2 block w-full rounded border-gray-300 text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">CGPA/Grade</label>
                            <input type="text" name="qualifications[0][cgpa_grade]" value="{{ old('qualifications.0.cgpa_grade') }}" class="h-10 px-2 block w-full rounded border-gray-300 text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Institute/Board/University</label>
                            <input type="text" name="qualifications[0][institute_board_university]" value="{{ old('qualifications.0.institute_board_university') }}"" class="h-10 px-2 block w-full rounded border-gray-300 text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Country</label>
                            <input type="text" name="qualifications[0][country]" value="{{ old('qualifications.0.country') }}" class="h-10 px-2 block w-full rounded border-gray-300 text-sm">
                        </div>
                    </div>
                </div>
                ...
                <div id="experience-container">
                    <div class="experience-row grid grid-cols-1 md:grid-cols-5 gap-4 mb-4 p-4 border rounded-lg">
                        <div>
                            ...
                            <input type="text" name="experiences[0][institution_organization]" value="{{ old('experiences.0.institution_organization') }}" class="h-10 px-2 block w-full rounded border-gray-300 text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Position/Job Title</label>
                            <input type="text" name="experiences[0][position_job_title]" value="{{ old('experiences.0.position_job_title') }}" class="h-10 px-2 block w-full rounded border-gray-300 text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">From Date</label>
                            <input type="date" name="experiences[0][from_date]" value="{{ old('experiences.0.from_date') }}" class="h-10 px-2 block w-full rounded border-gray-300 text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">To Date</label>
                            <input type="date" name="experiences[0][to_date]" value="{{ old('experiences.0.to_date') }}" class="h-10 px-2 block w-full rounded border-gray-300 text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Total Period (Months)</label>
                            <input type="number" name="experiences[0][total_period_months]" value="{{ old('experiences.0.total_period_months') }}" class="h-10 px-2 block w-full rounded border-gray-300 text-sm">
                        </div>
                    </div>
                </div>
                ...
                <div id="references-container">
                    <div class="reference-row grid grid-cols-1 md:grid-cols-3 gap-4 mb-4 p-4 border rounded-lg">
                        <div>
                            ...
                            <input type="text" name="references[0][name]" value="{{ old('references.0.name') }}" class="h-10 px-2 block w-full rounded border-gray-300 text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Designation</label>
                            <input type="text" name="references[0][designation]" value="{{ old('references.0.designation') }}"" class="h-10 px-2 block w-full rounded border-gray-300 text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Contact No.</label>
                            <input type="text" name="references[0][contact_no]" value="{{ old('references.0.contact_no') }}"" class="h-10 px-2 block w-full rounded border-gray-300 text-sm">
                        </div>
                    </div>
                </div>
    ...
    @if(isset($user) && $user->photo)
        <div class="mb-2">
            <img src="{{ asset('storage/' . $user->photo) }}" alt="Current Photo" class="h-16 w-16 object-cover rounded">
        </div>
    @endif
