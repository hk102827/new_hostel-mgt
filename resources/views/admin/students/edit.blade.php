            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="address" rows="3" 
                              class="px-3 py-2 block w-full rounded-lg border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 text-base">{{ old('address', $student->address) }}</textarea>
                </div>
    ...
    <select name="room_id" 
        ...
        @foreach($available_rooms as $room)
            <option value="{{ $room->id }}" 
                {{ old('room_id', $assigned_room_id) == $room->id ? 'selected' : '' }}>
