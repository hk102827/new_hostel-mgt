    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                        ...
                        <div class="flex items-center mt-2">
                            <div class="bg-green-300 h-2 rounded-full w-full">
                                <div class="bg-white h-2 rounded-full" 
                                     style="width: {{ ($stats['occupied_rooms'] / $stats['total_rooms']) * 100 }}%"></div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="p-4 bg-green-50">
                <a href="{{ route('admin.rooms.index') }}" class="text-green-600 hover:text-green-800 text-sm font-medium">
                    Manage Rooms →
                </a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="p-4 bg-purple-50">
                <a href="{{ route('admin.academy.index') }}" class="text-purple-600 hover:text-purple-800 text-sm font-medium">
                    View Academy →
                </a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="p-4 bg-orange-50">
                <a href="{{ route('admin.mess.index') }}" class="text-orange-600 hover:text-orange-800 text-sm font-medium">
                    Manage Mess →
                </a>
            </div>
        </div>
   ...
   <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="p-4 bg-emerald-50">
                <a href="{{ route('admin.reports.index') }}?type=revenue" class="text-emerald-600 hover:text-emerald-800 text-sm font-medium">
                    View Report →
                </a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                      ...
                      <p class="text-3xl font-bold">{{ $stats['collection_rate'] }}%</p>
                        <div class="flex items-center mt-2">
                            <div class="bg-indigo-300 h-2 rounded-full w-full">
                                <div class="bg-white h-2 rounded-full" style="width: {{ $stats['collection_rate'] }}%"></div>
                            </div>
                        </div>
            ...
            <div class="p-4 bg-indigo-50">
                <a href="{{ route('admin.fees.index') }}" class="text-indigo-600 hover:text-indigo-800 text-sm font-medium">
                    Fee Management →
                </a>
            </div>
        </div>
                ...
                <div class="bg-yellow-50 border-l-4 border-yellow-400 p-3 mb-4">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-yellow-700">Rooms are {{ round(($stats['occupied_rooms'] / $stats['total_rooms']) * 100) }}% full</p>
                        </div>
                    </div>
                </div>
                @endif
                ...
                <div class="bg-red-50 border-l-4 border-red-400 p-3 mb-4">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-red-700">Rs. {{ number_format($stats['pending_fees']) }} pending collection</p>
                        </div>
                    </div>
                </div>
                @endif
